...
class Specimen(VersionedMixin, Base):
    """
    DEFINITION:
    ...
    performing_material: Mapped[Material] = relationship(
        back_populates="performed_specimen", cascade="all, delete-orphan", single_parent=True
    )
