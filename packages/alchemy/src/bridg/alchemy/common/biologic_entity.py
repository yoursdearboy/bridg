...
class BiologicEntity(VersionedMixin, Base):
    """
...
class BiologicEntityName(VersionedMixin, EntityName, EntityNameParts, Base):
...
class BiologicEntityIdentifier(VersionedMixin, ID):
