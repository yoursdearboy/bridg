...
class Person(BiologicEntity):
    ...
    postal_address: Mapped[List[PersonPostalAddress]] = relationship(
        back_populates="person",
        cascade="all, delete-orphan",
    )

    telecom_address: Mapped[List[PersonTelecommunicationAddress]] = relationship(
        back_populates="person",
        cascade="all, delete-orphan",
    )


class PersonPostalAddress(VersionedMixin, datatype.PostalAddress):
...
class PersonTelecommunicationAddress(VersionedMixin, datatype.TelecommunicationAddress):
