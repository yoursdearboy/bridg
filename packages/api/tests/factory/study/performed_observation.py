...
from bridg.api.model import PerformedObservationData

from ..base import BaseFactory
from ..datatype import ConceptDescriptorFactory, IntervalPointInTimeFactory


class PerformedObservationDataFactory(BaseFactory[PerformedObservationData]):
    comment = None
    reason_code = None
    ...
    resulted_performed_observation_result = Use(lambda: [])
