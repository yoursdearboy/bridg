...
class PerformedActivityDataBase[T: bridg.alchemy.PerformedActivity](BaseModel[T]):
    comment: Optional[str]
    date_range: Optional[IntervalPointInTime]
    negation_indicator: Optional[bool]
    negation_reason: Optional[ConceptDescriptor]
...
class PerformedActivityData(PerformedActivityDataBase[bridg.alchemy.PerformedActivity]):
